...
const Auth = () => {
  ...
  return (
    <div className='min-h-screen overflow-hidden bg-white text-black px-8'>
      ...
      {/* {main section} */}
      <main
        className='max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center'
      >
        ...
        >
          ...
          <p className='mt-4 text-sm text-gray-500'>
            Start with 100 free creadits • Upgrade anytime for more credits • Instant access       
          </p>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
          <Feature 
            icon="🎁" 
            title="100 Free Creadits"
            des="Start with 100 creadits to generate notes without paying." 
          />
          <Feature 
            icon="📘" 
            title="Exam Notes"
          ...
          <Feature 
            ...
            des="well-structured documentation for assignment & projects." 
          />
          <Feature 
            icon="📊" 
            title="Charts & Graphs"
...
function Feature({icon , title , des}){
  return(
    <motion.div 
      ...
      bg-linear-to-br from-black/90 via-black/80 ot-black/90
      backdrop-blur-2xl
      border border-white/10
      shadow-[0_25px_45px_rgba(0,0,0,0.7)]
      text-white'
