...
const Home = () => {
  ...
  return (
    <div className=' min-h-screen overflow-hidden bg-white text-black' >
      ...
      {/* top */}
      <section className='max-w-7xl mx-auto px-8 pt-15 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center'>
        {/* left */}
        <div>
          <motion.div
          ...
          >
            <motion.h1
              whileHover={{y:-4}}
              style={{transform:"translateZ(40px)",textShadow: "0 10px 40px rgba(0,0,0,0.25)"}}
      ...
      <section className='max-w-6xl mx-auto px-8 py-20 grid grid-cols-1 md:grid-cols-4 gap-10'>
        ...
        <Feature 
            ...
            des="well-structured content for assignment & projects." 
          />
          <Feature 
            icon="📊" 
            title="Diagram"
            des="Auto-generated diagrams fro clarity ." 
          />
          <Feature 
            icon="⬇️" 
